...
set _CLASSPATH=%CLASSPATH%;"lib\mariadb-java-client-3.3.0.jar;lib\orm.jar"
...
"%_JAVACCMD%" -encoding UTF-8 -d %_CLASSES% -classpath %_CLASSPATH% %_SOURCEPATH%\de/hhn/se/pmt/foodmood/model\*.java %_SOURCEPATH%\ormsamples\*.java 
