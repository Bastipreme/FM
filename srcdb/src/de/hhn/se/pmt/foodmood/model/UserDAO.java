...
public class UserDAO {
	...
	public static User loadUserByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (User) session.load(de.hhn.se.pmt.foodmood.model.User.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static User getUserByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (User) session.get(de.hhn.se.pmt.foodmood.model.User.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static User loadUserByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.load(de.hhn.se.pmt.foodmood.model.User.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static User getUserByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.get(de.hhn.se.pmt.foodmood.model.User.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			throw new PersistentException(e);
		}
	...
	public static List queryUser(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From de.hhn.se.pmt.foodmood.model.User as User");
		if (condition != null)
	...
	public static boolean save(de.hhn.se.pmt.foodmood.model.User user) throws PersistentException {
		try {
			FoodMoodPersistentManager.instance().saveObject(user);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
	...
	public static boolean delete(de.hhn.se.pmt.foodmood.model.User user) throws PersistentException {
		try {
			FoodMoodPersistentManager.instance().deleteObject(user);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
	...
	public static boolean refresh(de.hhn.se.pmt.foodmood.model.User user) throws PersistentException {
		try {
			FoodMoodPersistentManager.instance().getSession().refresh(user);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
	...
	public static boolean evict(de.hhn.se.pmt.foodmood.model.User user) throws PersistentException {
		try {
			FoodMoodPersistentManager.instance().getSession().evict(user);
			return true;
		}
		catch (Exception e) {
			throw new PersistentException(e);
