...
public class FoodMoodPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "FoodMood";
	...
	private FoodMoodPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.User.class);
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.HungryUser.class);
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.Administrator.class);
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.Reminder.class);
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.FoodBusinessOwner.class);
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.Dish.class);
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.Rate.class);
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.Recipe.class);
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.Location.class);
		aMetadataSources.addAnnotatedClass(de.hhn.se.pmt.foodmood.model.FoodBusiness.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new FoodMoodPersistentManager();
		}
